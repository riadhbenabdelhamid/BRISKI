        ...
        always_comb begin
            ...
            if (load_pipe0) begin
                ...
                case (funct3_pipe0[1:0])
                    2'b00:   o_dmem_post = {{24{(~funct3_pipe0[2] & dmem_byte[7])}}, dmem_byte};  // LB/LBU //000 LB (byte is sign extended) //100 LBU (zero extend)
                    2'b01:   o_dmem_post = {{16{(~funct3_pipe0[2] & dmem_half[15])}}, dmem_half};  // LH/LHU //001 LH (Half is sign extended) //101 LHU (zero extend)
