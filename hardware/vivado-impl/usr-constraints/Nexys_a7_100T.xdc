...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { REFCLK_P }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { DONE_GPIO_LED_0 }]; #IO_L18P_T2_A24_15 Sch=led[0]
